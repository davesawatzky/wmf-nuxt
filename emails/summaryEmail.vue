  ...
  <mjml>
    <mj-head>
      ...
      <mj-attributes>
        ...
        <mj-text
          ...
          color="#005984"
          line-height="20px"
          font-family="Raleway, Helvetica, Arial, sans-serif"></mj-text>
        <mj-section
          padding="0px 25px"
    ...
    <mj-body
      ...
      <mj-section
        ...
        background-color="#E7E7E7">
        <mj-column width="100%"><mj-spacer height="40px" /> </mj-column>
      </mj-section>
      <mj-wrapper
        padding-top="0px"
        padding-bottom="0"
          ...
          <mj-section>
            <mj-column>
              ...
              <mj-text>
                ...
                <div class="h3">Group Name: {{ community.name }}</div>
              </mj-text>
            </mj-column>
          </mj-section>
          <mj-section>
            ...
            <mj-column>
              <mj-text>
                ...
                <div>
                  Performers in other classes:
                  {{ community.conflictPerformers }}
                </div>
              </mj-text>
            </mj-column>
          </mj-section>
          ...
          <mj-column>
            ...
            <mj-text>
              ...
              <div
                ...
                <div>
                  Subdiscipline:
                  {{ registeredClass.subdiscipline?.toUpperCase() }}
                </div>
          ...
          <mj-column>
            ...
            <mj-text>
              ...
              <p>
                ...
                studio registration confirmation mailing sent to teachers.
              </p>
              <p>
                Submissions may still be viewed on the website upon logging in.
                In case of any discrepencies between the information in this
                registration form and the official syllabus, the official
                syllabus will always be considered correct.
              </p>
              <p>
                Please take note of the confirmation number for your records.
                This number may be requested with any communication regarding
                your application. No changes will be permitted once the entry
